...
Схема навигации и страницы мобильного приложения: подключение к устройствам, запись, управление файлами и обработанными сессиями.

## Поток данных

![Диаграмма последовательности](assets/SequenceDiagram.png)

Диаграмма последовательности: от BLE‑устройства до сервиса полисомнографии.

...
import 'package:ble_app/features/ble/device_details_page.dart';
import 'package:ble_app/features/ble/widgets/device_list.dart';
import 'package:ble_app/core/theme/app_theme.dart';

// view for ble device list and connection status; shows connected + scan results
class ConnectionPage extends StatelessWidget {
  const ConnectionPage({super.key});

  static Widget buildConnectionStatusIndicator(BleController controller) {
    return Obx(() {
  ...
  static Widget buildConnectedDeviceCard(BleController controller) {
    return Obx(() {
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                onTap: () => Get.to(() => DeviceDetailsPage(device: device)),
                trailing: Row(
  ...
  static Widget buildDeviceListSection(BleController controller) {
    return Obx(() {
      final connectedId =
          controller.connectedDevice.value?.remoteId.str;
                  ...
                  builder: (context, snapshot) {
                    ...
                    return DeviceListTile(
                      ...
                      onDetailsPressed: isConnected
                          ? () => Get.to(() =>
                              DeviceDetailsPage(device: data.device))
                          : null,
                    );
                  },
                );
      ...
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              buildConnectionStatusIndicator(controller),
              Obx(() {
          ...
          body: Column(
            children: [
              ...
              buildConnectedDeviceCard(controller),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Align(
                  alignment: Alignment.centerLeft,
              ...
              Expanded(child: buildDeviceListSection(controller)),
            ],
          ),
        );
      },

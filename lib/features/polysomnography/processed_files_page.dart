...
class ProcessedFilesPageState extends State<ProcessedFilesPage>
  ...
  // assigns sleep graph index; always use file.index (backend returns same jsonIndex for different files)
  ...
  Future<void> openDetails(
    ...
    final sleepGraphIndex = state.sleepGraphIndex ?? file.index;

...
class HypnogramImageState extends State<HypnogramImage> {
  late Future<List<int>> imageLoadFuture;
    ...
    return FutureBuilder<List<int>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          ...
          return HypnogramErrorContent(
            message: msg,
            onRetry: (is404 && widget.onRetry != null) ? _handleRetry : null,
          ...
          children: [
            ...
            if (onRetry != null) ...[
              ...
              FilledButton.icon(
                ...
                label: Text(isRetrying ? 'Повтор...' : 'Повторить запрос анализа'),
              ),
            ],
          ],
        ),
...
class SessionDetailsPage extends StatelessWidget {
  ...
  final int jsonIndex;
  final PolysomnographyApiService service;
  final Future<void> Function()? onRetryPredict;
